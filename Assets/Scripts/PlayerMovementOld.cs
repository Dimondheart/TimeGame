...
namespace TechnoWolf.Project1
{
	...
	public class PlayerMovementOld : RecordableMonoBehaviour
	{
		...
		public sealed class TimelineRecord_PlayerMovement : TimelineRecordForBehaviour<PlayerMovementOld>
		{
			public bool isApplyingMotion;
			...
			protected override void RecordState(PlayerMovementOld pm)
			{
				base.RecordState(pm);
			...
			protected override void ApplyRecord(PlayerMovementOld pm)
			{
				base.ApplyRecord(pm);
