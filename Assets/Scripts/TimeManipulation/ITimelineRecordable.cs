...
namespace TechnoWolf.TimeManipulation
{
	...
	public interface ITimelineRecordable
	{
		...
		TimelineRecordForBehaviour MakeTimelineRecord();
		 ...
		 * in at this time, excluding any data that should not be recorded.</summary>
		 */
		void RecordCurrentState(TimelineRecordForBehaviour record);
		 ...
		 * record.</summary>
		 */
		void ApplyTimelineRecord(TimelineRecordForBehaviour record);
	}
}
